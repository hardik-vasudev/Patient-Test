...
const EmergencyPage = () => {
  ...
  const handleProceed = () => {
    if (selectedIssue && age) {
      navigate("/WaitingScreen"); // Redirect to waiting screen
    }
  };
      ...
      <div className="flex w-full max-w-4xl mt-6 gap-6">
        ...
        <div className="flex flex-col w-1/2 bg-white p-4 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            <KioskButton text="🩺 Consult with Doctor" onClick={handleProceed} color="green" />
            <KioskButton text="🤖 AI Doctor" onClick={() => navigate("/AIDoctor")} color="blue" />
          </div>
        </div>
      </div>
