...
import { FaVideo, FaRobot, FaUserMd, FaUser, FaHome } from "react-icons/fa";

const MainMenu = () => {
  const navigate = useNavigate();

  const menuItems = [
    { id: 1, label: "Teleconsultation", icon: <FaVideo size={50} />, route: "/teleconsultation", bgColor: "bg-blue-500", hoverColor: "hover:bg-blue-600" },
    { id: 2, label: "AI Doctor", icon: <FaUserMd size={50} />, route: "/ai-doctor", bgColor: "bg-green-500", hoverColor: "hover:bg-green-600" },
    { id: 3, label: "JivanAI Chatbot", icon: <FaRobot size={50} />, route: "/jivanai", bgColor: "bg-yellow-500", hoverColor: "hover:bg-yellow-600" },
